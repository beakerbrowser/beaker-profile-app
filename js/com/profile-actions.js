...
class ProfileActions extends LitElement {
  ...
  renderOtherUser () {
    return html`
      ...
      ${''/* TODO do we need this control? this.user.isSaved
        ? html`
          <beaker-hoverable>
            <button class="btn" slot="default" style="width: 150px"><span class="fa fa-fw fa-check"></span> Added to Library</button>
            <button class="btn warning" slot="hover" style="width: 150px"><span class="fa fa-times"></span> Remove</button>
          </beaker-hoverable>`
        : html`
          <button class="btn">
  ...
  /*TODO do we need this control? async onToggleSaved () {
